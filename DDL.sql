-- Active: 1706776141527@@127.0.0.1@3306@estate
# Entity
# - 사용자
# - 이메일 인증 번호 
# - 게시물
...
# Attribute  
# - 사용자(아이디[PK], 비밀번호, 이메일, 권한, 가입 경로)
# - 이메일 인증번호 (이메일[PK], 인증번호)
# - 게시물 (접수번호[PK], 상태, 제목, 작성자, 작성일, 조회수, 내용, 답변)
# - 부동산 ( 번호, 시도, 시군구, 매매 평균, 보증금 평균, 월세 평균, 수익률 평균 40 이하, 매매 가격 대비 전세 비율 40 이하, 전세가, 전세 가격 대비 월세 보증금 비율 40 초과, 전세가격 대비 월세 보증금 비율 40 이하)
...
# user_email : VARCHAR(100) NN UQ FK (email_auth_number
